...
(* OASIS_START *)
(* DO NOT EDIT (digest: 20029658795e651c29e61692c34bfabd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Christoph H\195\182ger <christoph.hoeger@tu-berlin.de>"];
          homepage = None;
          synopsis =
            "An embedded language for differential-algebraic equations";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-ltnp"])];
                      bs_dlllib = [(OASISExpr.EBool true, ["libtnp"])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {exec_custom = false; exec_main_is = "e2bench.ml"});
               Doc
                 ({
                     cs_name = "api-e2lang";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for e2lang";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "e2test.ml"});
               Test
                 ({
                     cs_name = "e2test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "e2lang"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "e2main.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\2054\254W\188\025\127l\240\162I \131\250\197f";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
